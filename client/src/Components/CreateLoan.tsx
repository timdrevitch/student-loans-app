...
const CreateLoan: FC = () => {
    ...
    const changeLoan = (e: ChangeEvent<HTMLInputElement>) => setLoanName(e.target.value)
    ...
    return (
        <div style={{backgroundColor: "#1a1d22", border: "1px solid black", borderRadius: "10px", margin: "5rem 10px 0 10px"}}>
            <form onSubmit={createNewLoan}>
                ...
                <input type="text" id="loan" name="loan" value={loanName} onChange={changeLoan} required/>
                <br/>
